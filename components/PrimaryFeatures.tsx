...
import ssd from '@/public/images/screenshots/ssd.png'
import ram from '@/public/images/screenshots/ram.png'
import ssdram from '@/public/images/screenshots/ssd-ram.png'

const features = [
  {
    title: 'Changement de Disque SSD',
    description:
      "Rendez votre ordinateur plus rapide que jamais grâce à un SSD. Laissez derrière vous les longs temps de démarrage et accédez instantanément à vos fichiers et applications.",
    image: ssd,
  },
  {
    title: 'Augmentation de la Mémoire RAM',
    description:
      "Donnez à votre ordinateur la puissance de la mémoire RAM supplémentaire. Oubliez les ralentissements dus à la surcharge de données et exécutez plusieurs applications en toute fluidité.",
    image: ram,
  },
  {
